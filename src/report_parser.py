...
class ReportParser(object):
	...
	def parse(self, input_whole):
		...
		#TODO in insert: 'stable':dict_buildings[''], 'workshop':dict_buildings[''], 'church':dict_buildings[''], 'first_church':dict_buildings[''], 'academy':dict_buildings[''], 'market':dict_buildings[''], 'attacker_luck':['']:[''], 'away_spears':['']:[''], 'away_archers':[''], 'away_scouts':[''], 'away_lcav':[''], 'away_mounted_archers':[''], 'away_hcav':[''], 'away_rams':[''], 'away_catapults':[''], 'away_paladin':[''], 'away_nobleman':['']
		...
		if select_result:
			print("skipping this import, as one of equal age or newer is already in DB")
		else:
